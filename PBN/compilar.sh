...
gcc -pthread -Wall Semaforo/Semaforo.h Semaforo/Semaforo.c DynamicLists.h DynamicLists.c SHM/SHMFun.h SHM/SHMFun.c Sockets/SocketFunc.h Sockets/SocketFunc.c Actuador/AFun.h Actuador/AFun.c Actuador/AFun.h Actuador/Actuador.c;
